    ...
    <div>
      ...
      <div className='space-y-20'>
        ...
        <div key={achievement.title} className='flex justify-center items-center '>
          <div className='flex flex-col lg:flex-row lg:justify-around lg:items-center gap-8 w-full max-w-md lg:max-w-full border px-4 py-6 bg-background-v1 backdrop-blur-3xl border-zinc-800  rounded-xl'>
